...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, type, ...props }, ref) => {
    // Check if this is a date-related input type
    ...
    return (
      <input
        ...
        className={cn(
          ...
          // Date input specific styles for dark mode calendar icon
          isDateInput && "[color-scheme:dark] dark:[color-scheme:dark] [&::-webkit-calendar-picker-indicator]:dark:invert [&::-webkit-calendar-picker-indicator]:cursor-pointer [&::-webkit-calendar-picker-indicator]:opacity-70 [&::-webkit-calendar-picker-indicator]:hover:opacity-100",
          className
        )}
        ref={ref}
        {...props}
